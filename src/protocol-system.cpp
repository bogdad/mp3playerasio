...
// TODO: this leaks resources in error
      ...
      _p2 = (char *)mmap((char *)p + len, len, PROT_WRITE,
      ...
      if (!(_p1 = (char *)MapViewOfFileEx(_file_handle, FILE_MAP_ALL_ACCESS, 0,
                                          0, len, ptr))) {
        return -1;
      }

      if (!(_p2 = (char *)MapViewOfFileEx(_file_handle, FILE_MAP_ALL_ACCESS, 0,
                                          0, len, (char *)ptr + len))) {
